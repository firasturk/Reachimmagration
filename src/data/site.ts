...
export interface Branch { id: string; lat: number; lng: number; en: string; ar: string; country: string; address: { en: string; ar: string }; phones: string[]; email?: string }
...
export const branches: Branch[] = [
  { id: 'amman', lat: 31.95, lng: 35.93, en: 'Jordan — Amman', ar: 'الأردن — عمّان', country: 'Jordan', address: { en: '3rd floor, 14 King Faisal Bin Abdulaziz Street, Umm Uthaina', ar: 'الطابق الثالث، 14 شارع الملك فيصل بن عبد العزيز، أم أذينة' }, phones: ['+962 6 552 1114', '+962 79 063 1087'], email: 'info@reachimmigration.com' },
  { id: 'baghdad', lat: 33.31, lng: 44.37, en: 'Iraq — Baghdad', ar: 'العراق — بغداد', country: 'Iraq', address: { en: 'Nadi Al Said Street, beside the German Embassy, Al Amirat, Al Mansour', ar: 'شارع نادي الصيد، بجانب السفارة الألمانية، الأميرات، المنصور' }, phones: ['+964 772 900 2299'] },
  { id: 'erbil', lat: 36.19, lng: 44.01, en: 'Iraq — Erbil', ar: 'العراق — أربيل', country: 'Iraq', address: { en: 'Empire Business Towers, Building T2, 15th floor, Office 2', ar: 'أبراج إمباير للأعمال، المبنى T2، الطابق 15، مكتب 2' }, phones: ['+964 66 291 3333'], email: 'erbil@reachimmigration.com' },
  { id: 'basra', lat: 30.51, lng: 47.81, en: 'Iraq — Basra', ar: 'العراق — البصرة', country: 'Iraq', address: { en: 'Al Medaan Street, beside Manawi Center Building, Manawi Basha', ar: 'شارع الميدان، بجانب بناية مركز مناوي، مناوي باشا' }, phones: ['+964 782 900 3399', '+964 772 900 3399'], email: 'basra@reachimmigration.com' },
  { id: 'cairo-5th', lat: 30.04, lng: 31.24, en: 'Egypt — Cairo, 5th Settlement', ar: 'مصر — القاهرة، التجمع الخامس', country: 'Egypt', address: { en: 'Sodic Eastown, New Cairo Gate 9, next to the AUC, Building 7, 1st floor, Office 2', ar: 'سوديك إيست تاون، بوابة 9 القاهرة الجديدة، بجوار الجامعة الأمريكية، مبنى 7، الدور الأول، مكتب 2' }, phones: ['+20 2 6330 1649'] },
  { id: 'cairo-october', lat: 30.04, lng: 31.24, en: 'Egypt — Cairo, 6 October', ar: 'مصر — القاهرة، 6 أكتوبر', country: 'Egypt', address: { en: 'Office 102, Capital Business Park B2, Plots 15–16, Sheikh Zayed City, Giza', ar: 'مكتب 102، كابيتال بيزنس بارك B2، قطعة 15–16، مدينة الشيخ زايد، الجيزة' }, phones: ['+20 2 3865 3816'] },
  { id: 'cairo-maadi', lat: 30.04, lng: 31.24, en: 'Egypt — Cairo, Maadi', ar: 'مصر — القاهرة، المعادي', country: 'Egypt', address: { en: 'Rayhanah Plaza (Morshdy Group), Zahraa Al Maadi, Tower A, 4th floor, Office 12-4', ar: 'ريحانة بلازا (مجموعة مرشدي)، زهراء المعادي، برج A، الدور الرابع، مكتب 12-4' }, phones: ['+20 2 2519 9887'] },
  { id: 'cairo-sheraton', lat: 30.04, lng: 31.24, en: 'Egypt — Cairo, Sheraton', ar: 'مصر — القاهرة، شيراتون', country: 'Egypt', address: { en: 'Office 16, 4th floor, 87 Al Mosheer Ahmed Ismail Street, Sheraton, Heliopolis', ar: 'مكتب 16، الدور الرابع، 87 شارع المشير أحمد إسماعيل، شيراتون، مصر الجديدة' }, phones: ['+20 2 2064 4175'] },
  { id: 'alexandria', lat: 31.2, lng: 29.92, en: 'Egypt — Alexandria', ar: 'مصر — الإسكندرية', country: 'Egypt', address: { en: 'Office 20, 1st floor, Four Seasons Hotel San Stefano, El Gaish Road', ar: 'مكتب 20، الدور الأول، فندق فورسيزونز سان ستيفانو، طريق الجيش' }, phones: ['+20 3 469 1361'] },
  { id: 'riyadh', lat: 24.71, lng: 46.68, en: 'Saudi Arabia — Riyadh', ar: 'السعودية — الرياض', country: 'Saudi Arabia', address: { en: 'Al Takhasosi Street, Al Thumamah Road, above Al Jazira Bank, 2nd floor, Office 23', ar: 'شارع التخصصي، طريق الثمامة، فوق بنك الجزيرة، الدور الثاني، مكتب 23' }, phones: ['+966 11 402 1112'] },
  { id: 'jeddah', lat: 21.49, lng: 39.19, en: 'Saudi Arabia — Jeddah', ar: 'السعودية — جدة', country: 'Saudi Arabia', address: { en: 'Office 504, 5th floor, Arkan Building, Nahdat Al Tareekh Street, Al Rawda', ar: 'مكتب 504، الدور الخامس، مبنى أركان، شارع نهضة التاريخ، حي الروضة' }, phones: ['+966 12 288 9772', '+966 50 203 3325'], email: 'jeddah@reachimmigration.com' },
  { id: 'khobar', lat: 26.22, lng: 50.2, en: 'Saudi Arabia — Khobar', ar: 'السعودية — الخبر', country: 'Saudi Arabia', address: { en: 'Office 905, 9th floor, Awj Tower, Prince Turki Road', ar: 'مكتب 905، الدور التاسع، برج أوج، طريق الأمير تركي' }, phones: ['+966 13 882 0022'] },
  { id: 'doha', lat: 25.29, lng: 51.53, en: 'Qatar — Doha', ar: 'قطر — الدوحة', country: 'Qatar', address: { en: 'Office 3, 22nd floor, Amwal Tower, Al Sufara Street, West Bay', ar: 'مكتب 3، الطابق 22، برج أموال، شارع السفراء، الخليج الغربي' }, phones: ['+974 4450 4390', '+974 3322 2773'], email: 'doha@reachimmigration.com' },
  { id: 'dubai', lat: 25.2, lng: 55.27, en: 'United Arab Emirates — Dubai', ar: 'الإمارات — دبي', country: 'UAE', address: { en: 'Office 505, 5th floor, U-Bora Tower, Towers Street, Business Bay', ar: 'مكتب 505، الطابق الخامس، برج يو بورا، شارع الأبراج، الخليج التجاري' }, phones: ['+971 4 514 7669'] },
  { id: 'kuwait', lat: 29.37, lng: 47.98, en: 'Kuwait', ar: 'الكويت', country: 'Kuwait', address: { en: 'Office 43, 15th floor, Salwa Tower, Abdul Aziz Al Saqr Street, Block 1, Al Murqab, Kuwait City', ar: 'مكتب 43، الطابق 15، برج سلوى، شارع عبد العزيز الصقر، قطعة 1، المرقاب، مدينة الكويت' }, phones: ['+965 9922 6271'] },
  { id: 'istanbul', lat: 41.01, lng: 28.98, en: 'Turkey — Istanbul', ar: 'تركيا — إسطنبول', country: 'Turkey', address: { en: 'Nidakule, Kayaşehir Bulvarı No. 45, 25th floor, No. 180, Kayabaşı, Başakşehir', ar: 'نيدا كوله، جادة كاياشهير رقم 45، الطابق 25، رقم 180، كاياباشي، باشاك شهير' }, phones: ['+90 212 285 19 45'] },
  { id: 'larnaca', lat: 34.92, lng: 33.63, en: 'Cyprus — Larnaca', ar: 'قبرص — لارنكا', country: 'Cyprus', address: { en: 'Vasileos Evagorou 14, 6023 Larnaca', ar: 'شارع فاسيليوس إيفاغورو 14، 6023 لارنكا' }, phones: ['+357 24 666 969', '+357 96 909 069'], email: 'cyprus@reachimmigration.com' },
];
