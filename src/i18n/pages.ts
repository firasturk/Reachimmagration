...
const en = {
  ...
  contact: {
    ...
    branchesTitle: ['Our', 'Branches'], branchesText: 'Choose the branch nearest you in the form and a consultant from that office will call you back.', branchNote: 'Branch numbers and addresses are being added. Until then the head office connects you to any branch.',
  },
  legal: {
...
const ar: typeof en = {
  ...
  contact: {
    ...
    branchesTitle: ['فروعنا', ''], branchesText: 'اختر أقرب فرع إليك في النموذج ليتصل بك مستشار من ذلك المكتب.', branchNote: 'تُضاف أرقام الفروع وعناوينها تباعاً. حتى ذلك الحين يصلك المقر الرئيسي بأي فرع.',
  },
  legal: {
